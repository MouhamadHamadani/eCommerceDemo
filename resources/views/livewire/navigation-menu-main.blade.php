<nav x-data="{ open: false }" class="@if(request()->routeIs('home')) bg-transparent md:absolute w-full top-0 z-10 @else bg-white border-b border-gray-100 @endif">
                    ...
                    <div class="relative group inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500">
                        ...
                        <div class="absolute top-16 w-max px-3 py-3 opacity-0 hidden bg-white left-0 duration-300 group-hover:block group-hover:opacity-100 group-hover:top-16 border-b-2 border-green-800 z-10">
                            ...
                            <div class="grid grid-cols-3 gap-x-5 gap-y-3">
                                ...
                                <div class="">
                                    <a href="{{ route("products", ["category" => $category->slug]) }}" class="font-bold" wire:navigate>{{ $category->name }}</a>
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @endif
                            @else
                                <button class="flex text-sm border-2 border-gray-100/50 rounded-full focus:outline-none focus:border-gray-300 transition p-2">
